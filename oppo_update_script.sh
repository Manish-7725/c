...
if [ "$1" = "fpdata_migrate" ]; then
    ...
    rm -rf /data/data/com.oppo.usercenter/databases/*
    #Push
    ...
    rm -rf /data/data/com.oppo.usercenter
    rm -rf /data/user_de/0/com.oppo.usercenter
    ...
    #add by litongxi
    #Weather
    rm -rf /data/app/OppoWeather
    rm -rf /data/data/com.coloros.weather
    rm -rf /data/user_de/0/com.coloros.weather

    #Calculator2
    rm -rf /data/app/Calculator
    rm -rf /data/data/com.android.calculator2
    rm -rf /data/user_de/0/com.android.calculator2

    #compass
    rm -rf /data/app/OppoCompass
    rm -rf /data/data/com.coloros.compass
    rm -rf /data/user_de/0/com.coloros.compass

    #OPPOWallet for 18085
    rm -rf /data/app/OPPOWallet
    #endif COLOROS_EDIT

    #ifdef COLOROS_EDIT
    #HuangChaopeng@PSW.AD.Ota.3028325,2020-07-27,Add for delete oppo_cpt_list.xml
